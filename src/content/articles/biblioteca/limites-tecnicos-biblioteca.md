---
title: Limites técnicos da biblioteca
section: biblioteca
...
Esses limites fazem parte da estratégia de simplicidade da Versão 1 da biblioteca.
...
- novos uploads serão bloqueados  
- o usuário precisará excluir um documento existente para adicionar outro
...
- indexação vetorial complexa  
- versionamento de documentos  
- organização por pastas  
- compartilhamento entre gabinetes distintos  
- upload automático a partir de tribunais  
- OCR ou processamento pesado de arquivos

Essas funcionalidades poderão ser avaliadas em evoluções futuras da plataforma.
