---
title: O chat respondeu algo diferente do esperado
section: problemas
...
Em alguns casos, a resposta pode não refletir exatamente o que o usuário esperava.

Isso normalmente está relacionado à forma como a pergunta foi feita ou às informações disponíveis no processo.
...
"Analise o caso considerando o IRDR salvo na minha biblioteca."

Isso pode ajudar o sistema a alinhar a resposta ao contexto institucional do usuário.
...
Por esse motivo, todas as respostas devem ser interpretadas como **apoio à análise**, e não como decisões automáticas.
