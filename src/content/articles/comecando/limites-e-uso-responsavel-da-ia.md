---
title: Limitações e uso responsável da inteligência artificial
section: comecando
...
- organizar informações presentes nos documentos  
- identificar elementos relevantes do processo  
- estruturar análises jurídicas  
- sugerir caminhos para a elaboração de decisões  
- apoiar a redação de minutas

Essas funcionalidades têm como objetivo **agilizar a análise processual**, mantendo sempre o controle humano sobre o resultado final.
...
Entre os limites importantes da tecnologia estão:

- não substitui o julgamento humano  
- não possui autoridade decisória  
- não garante interpretação jurídica única ou definitiva  
- não possui acesso a informações externas ao processo enviado

Por esse motivo, todas as análises devem ser **avaliadas criticamente pelo usuário** antes de qualquer utilização prática.
...
- o usuário decide quais documentos serão analisados  
- o usuário define quais perguntas serão feitas  
- o usuário avalia criticamente os resultados apresentados  
- qualquer minuta ou sugestão pode ser editada livremente

O sistema funciona como **instrumento de apoio**, preservando integralmente a autonomia do usuário.
...
Por esse motivo, é importante considerar que:

- as respostas do sistema são **geradas a partir dos documentos fornecidos e da pergunta realizada**  
- pequenas mudanças na pergunta podem gerar respostas diferentes  
- as respostas devem sempre ser interpretadas como **apoio à análise**, e não como conclusões definitivas

Essa transparência ajuda o usuário a compreender melhor o funcionamento da ferramenta.
...
Essa abordagem garante que a tecnologia contribua para aumentar a eficiência da análise processual, sem substituir a responsabilidade jurídica do usuário.
