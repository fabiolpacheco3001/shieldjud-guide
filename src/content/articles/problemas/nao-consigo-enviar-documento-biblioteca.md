---
title: Não consigo enviar um documento para a biblioteca
section: problemas
...
Caso o arquivo ultrapasse esse limite, o sistema bloqueará o envio.

Nesse caso, tente:

- reduzir o tamanho do arquivo  
- exportar novamente o documento com menor resolução  
- utilizar uma versão mais compacta do documento
...
- atualize a página  
- tente realizar o upload novamente  
- verifique se houve falha no envio do arquivo
...
Se necessário, entre em contato com o suporte da plataforma.