---
title: Boas práticas para construir uma biblioteca útil
section: biblioteca
...
Quando bem construída, a biblioteca ajuda o sistema a produzir respostas mais alinhadas com:

- práticas do gabinete  
...
- modelos de decisão utilizados pelo gabinete  
- enunciados institucionais  
- precedentes relevantes  
- IRDRs aplicáveis à matéria  
- orientações administrativas do tribunal

Esses materiais ajudam o chat a compreender melhor o contexto institucional em que o processo está sendo analisado.
...
"Elabore a minuta considerando o modelo de decisão salvo na minha biblioteca."

Isso permite alinhar a estrutura e o estilo da minuta com os padrões já utilizados na unidade judicial.
...
- orientações consolidadas do tribunal

Esses documentos podem ajudar o chat a contextualizar melhor determinadas questões jurídicas.
...
Sempre que possível, prefira materiais que:

- apresentem estrutura clara  
...
O objetivo é oferecer **contexto jurídico relevante para as interações conversacionais**.

Por esse motivo, recomenda-se evitar o uso da biblioteca para armazenar grandes volumes de documentos ou materiais que não serão utilizados como referência nas análises do chat.
...
- realizar o upload de uma versão atualizada

Isso ajuda a manter a biblioteca alinhada às práticas mais recentes.
...
- respostas mais alinhadas com o contexto institucional  
- geração de minutas mais próximas da prática do gabinete  
- análises jurídicas mais contextualizadas  
- maior consistência nas interações com o sistema
