---
title: Análise de convergência com precedentes
section: analises-artefatos
slug: analise-convergencia-precedentes
---

# Análise de convergência com precedentes

A **Análise de Convergência com Precedentes** é um artefato que identifica possíveis relações entre o processo analisado e precedentes relevantes do sistema de justiça.

O objetivo é apoiar o usuário na identificação de decisões que possam possuir **aderência temática ou estrutural** com o caso analisado.
...
- temas repetitivos do STF e do STJ  
- súmulas vinculantes e súmulas persuasivas  
- julgamentos de recursos representativos de controvérsia  
- hipóteses de improcedência liminar previstas no art. 332 do CPC  

Esses mecanismos buscam promover maior **uniformidade e previsibilidade na aplicação do direito**.
...
No primeiro grau de jurisdição, grande parte do acervo se concentra em temas como:
...
Quando corretamente identificados, processos com convergência a precedentes tendem a:

- tramitar entre **30% e 60% mais rapidamente**  
- apresentar menor taxa de recursos  
...
- **Contexto normativo**  
- **Núcleo fático**  
- **Requisitos de incidência do precedente**  
- **Pedidos típicos associados ao tema**  
- **Vedações e limites da aplicação do precedente**

Esses elementos permitem avaliar se existe **convergência estrutural entre o processo analisado e o precedente identificado**.
...
O relatório deve ser interpretado como **um instrumento de apoio à análise jurídica**, permitindo ao usuário avaliar se o precedente identificado pode ser:

- aplicado ao caso  
- distinguido (distinguishing)  
- utilizado como referência interpretativa  
- considerado irrelevante diante das particularidades do caso  

Essa avaliação permanece sob responsabilidade do usuário.
...
- aderência entre o núcleo fático do precedente e o caso concreto  
- correspondência entre os pedidos analisados  
