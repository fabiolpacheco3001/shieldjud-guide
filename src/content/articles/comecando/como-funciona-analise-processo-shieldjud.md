---
title: Como funciona a análise de um processo no ShieldJud
section: comecando
...
O usuário envia os documentos do processo para a plataforma e o sistema utiliza inteligência artificial para examinar os elementos jurídicos relevantes e produzir uma série de análises organizadas.

Essas análises são apresentadas ao usuário na forma de **artefatos estruturados**, que ajudam a compreender rapidamente a situação processual e os possíveis encaminhamentos do caso.
...
O usuário pode enviar diretamente os arquivos do processo, normalmente em formato PDF.

Em geral, os documentos enviados incluem:
...
Com a extensão instalada, o usuário pode selecionar os documentos dentro da própria pasta digital do processo e enviá-los para análise com um único comando.

Esse mecanismo evita etapas manuais de download e upload de arquivos.
...
Durante essa etapa, o sistema utiliza modelos de inteligência artificial treinados para analisar textos jurídicos e identificar elementos relevantes do processo.

Entre os aspectos examinados estão:

- estrutura da petição inicial  
- narrativa fática apresentada  
- pedidos formulados  
- documentos anexados  
- referências jurídicas presentes no processo  

A partir dessa análise, o sistema organiza as informações e produz diferentes artefatos analíticos.
...
Nesse ambiente o usuário pode acessar:
...
Cada artefato apresenta uma análise estruturada que pode ser expandida, copiada ou exportada.

Essas análises ajudam a:

- compreender rapidamente a estrutura do processo  
- identificar pontos que merecem atenção  
- visualizar a relação entre fatos, provas e normas jurídicas  
- estruturar o raciocínio antes de qualquer encaminhamento processual
...
As análises apresentadas pelo sistema devem ser compreensíveis e estruturadas de forma clara para o usuário.

---

### Rastreabilidade

O sistema mantém registro das informações utilizadas em cada análise, permitindo identificar a origem dos dados.

---

### Auditabilidade

As análises podem ser revisadas e verificadas, garantindo transparência no uso da tecnologia.

Esses princípios estão alinhados às diretrizes estabelecidas pela **Resolução CNJ nº 615/2025**, que regula o uso de inteligência artificial no Poder Judiciário brasileiro.
