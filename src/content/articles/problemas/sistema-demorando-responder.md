---
title: O sistema está demorando para responder
section: problemas
...
Isso geralmente está relacionado ao processamento dos documentos enviados ou à complexidade da análise solicitada.
...
- estruturar informações para análise

Dependendo do tamanho ou da quantidade de documentos, esse processamento pode levar alguns instantes.
...
- análises completas do processo  
- geração de minutas  
- avaliações jurídicas mais extensas

Nesses casos, o tempo de resposta pode ser um pouco maior.
...
- atualizar a página  
- iniciar uma nova interação no chat  
