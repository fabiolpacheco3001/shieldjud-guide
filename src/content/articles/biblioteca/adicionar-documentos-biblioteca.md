---
title: Como adicionar documentos à biblioteca
section: biblioteca
...
- IRDRs ou entendimentos consolidados  
- enunciados institucionais  
- orientações ou procedimentos internos
...
Eles podem ser acionados por:

- referência em linguagem natural  
- seleção manual dentro do chat

Os documentos **nunca são utilizados automaticamente**, garantindo controle total por parte do usuário.
