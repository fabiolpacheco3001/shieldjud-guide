---
title: Boas práticas para preparar documentos antes do upload
...
Sempre que possível, envie a versão completa da petição inicial, contendo:
...
Quando possível, organize os anexos de forma lógica, incluindo apenas documentos relevantes para compreender o caso.
...
Anexos desorganizados ou irrelevantes podem dificultar a análise do processo.
...
Antes do upload, verifique se os arquivos:
...
Duplicidades podem aumentar o volume de arquivos sem agregar informação relevante.
...
Certifique-se de que os documentos estejam nesse formato antes de iniciar o envio.
...
- dados de idosos ou pessoas vulneráveis
- documentos contendo informações pessoais desnecessárias para a análise do processo
...
- remover esses dados antes do envio
...
Ao enviar um processo para análise, o usuário declara que:

- possui autorização para utilizar os documentos enviados
...
- enviar a **petição inicial completa**
- incluir apenas **anexos relevantes**
- garantir que os documentos estejam **legíveis**
- evitar **arquivos duplicados**
- utilizar arquivos em **PDF**
- revisar os documentos para **remover dados sensíveis**
- não enviar processos sob **segredo de justiça**

Seguir essas práticas ajuda a garantir análises mais confiáveis e seguras.
