---
title: Boas práticas para usar o chat
section: chat
...
"Quais documentos sustentam o pedido de dano moral?"
...
Alguns exemplos de exploração incluem:

- verificar quais fatos sustentam determinados pedidos  
- identificar documentos associados a determinados argumentos  
- explorar inconsistências entre narrativa e provas

Esse tipo de interação pode ajudar a aprofundar a análise jurídica do caso.
...
"Explique os principais pontos de atenção identificados na análise consolidada."
...
- "Quem são as partes envolvidas e qual é o pedido principal?"
...
- "Existe pedido liminar neste processo?"
...
- "Quais provas sustentam a narrativa apresentada pela parte autora?"
...
- "A narrativa da petição inicial está bem sustentada por provas?"
...
- "Existe desconexão entre fatos, provas e pedidos?"
...
O sistema não cria fatos novos nem substitui a análise jurídica realizada pelo usuário.

O objetivo do chat é facilitar a exploração das informações disponíveis e apoiar a compreensão do processo.